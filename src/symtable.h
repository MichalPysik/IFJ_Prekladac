...
typedef struct SymTableDataStruct{
	...
	SymTableParamList functionParamDataTypes;			// ukazatel na lokální tabulku parametrů funkce (udělat jako seznam)
	SymTableParamList functionReturnDataTypes;			// ukazatel na lokální tabulku návratových parametrů funkce (udělat jako seznam)
	//int functionParamCount;									// počet parametrů funkce
	//int functionReturnParamCount;								// počet návratových parametrů funkce
